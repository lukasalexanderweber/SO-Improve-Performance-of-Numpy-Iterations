...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "cy_horizontal_adjacency",
        "sources": [
            "cy_horizontal_adjacency.pyx"
        ]
    },
    "module_name": "cy_horizontal_adjacency"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cy_horizontal_adjacency
#define __PYX_HAVE_API__cy_horizontal_adjacency
/* Early includes */
#include <stdint.h>
#include "pythread.h"
#include <string.h>
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_uint8_t(PyObject *, int writable_flag);
...
/* Module declarations from 'cy_horizontal_adjacency' */
...
#define __Pyx_MODULE_NAME "cy_horizontal_adjacency"
extern int __pyx_module_is_main_cy_horizontal_adjacency;
int __pyx_module_is_main_cy_horizontal_adjacency = 0;

/* Implementation of 'cy_horizontal_adjacency' */
...
static const char __pyx_k_adjacency_horizontal[] = "adjacency_horizontal";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_cy_horizontal_adjacency[] = "cy_horizontal_adjacency";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_cy_get_horizontal_adjacency[] = "cy_get_horizontal_adjacency";
static const char __pyx_k_cy_horizontal_adjacency_pyx[] = "cy_horizontal_adjacency.pyx";
...
static PyObject *__pyx_n_s_adjacency_horizontal;
...
static PyObject *__pyx_n_s_cy_get_horizontal_adjacency;
static PyObject *__pyx_n_s_cy_horizontal_adjacency;
static PyObject *__pyx_kp_s_cy_horizontal_adjacency_pyx;
...
static PyObject *__pyx_pf_23cy_horizontal_adjacency_cy_get_horizontal_adjacency(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cells); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_23cy_horizontal_adjacency_1cy_get_horizontal_adjacency(PyObject *__pyx_self, PyObject *__pyx_arg_cells); /*proto*/
static PyMethodDef __pyx_mdef_23cy_horizontal_adjacency_1cy_get_horizontal_adjacency = {"cy_get_horizontal_adjacency", (PyCFunction)__pyx_pw_23cy_horizontal_adjacency_1cy_get_horizontal_adjacency, METH_O, 0};
static PyObject *__pyx_pw_23cy_horizontal_adjacency_1cy_get_horizontal_adjacency(PyObject *__pyx_self, PyObject *__pyx_arg_cells) {
  ...
  __Pyx_RefNannySetupContext("cy_get_horizontal_adjacency (wrapper)", 0);
  assert(__pyx_arg_cells); {
    __pyx_v_cells = __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_uint8_t(__pyx_arg_cells, PyBUF_WRITABLE); if (unlikely(!__pyx_v_cells.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cy_horizontal_adjacency.cy_get_horizontal_adjacency", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_23cy_horizontal_adjacency_cy_get_horizontal_adjacency(__pyx_self, __pyx_v_cells);
...
static PyObject *__pyx_pf_23cy_horizontal_adjacency_cy_get_horizontal_adjacency(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cells) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("cy_get_horizontal_adjacency", 0);

  /* "cy_horizontal_adjacency.pyx":10
 * @initializedcheck(False)
 * def cy_get_horizontal_adjacency(uint8_t[:, ::1] cells):
 *     cdef int nrows = cells.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int ncols = cells.shape[1]
 ...
 */
  __pyx_v_nrows = (__pyx_v_cells.shape[0]);

  /* "cy_horizontal_adjacency.pyx":11
 * def cy_get_horizontal_adjacency(uint8_t[:, ::1] cells):
 *     cdef int nrows = cells.shape[0]
 *     cdef int ncols = cells.shape[1]             # <<<<<<<<<<<<<<
 *     cdef uint32_t[:, ::1] adjacency_horizontal = np.zeros((nrows, ncols), dtype=np.uint32)
 *     cdef int x, y, span
 */
  __pyx_v_ncols = (__pyx_v_cells.shape[1]);

  /* "cy_horizontal_adjacency.pyx":12
 *     cdef int nrows = cells.shape[0]
 *     cdef int ncols = cells.shape[1]
 *     cdef uint32_t[:, ::1] adjacency_horizontal = np.zeros((nrows, ncols), dtype=np.uint32)             # <<<<<<<<<<<<<<
 *     cdef int x, y, span
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_nrows); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_ncols); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uint32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_uint32_t(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_adjacency_horizontal = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "cy_horizontal_adjacency.pyx":14
 *     cdef uint32_t[:, ::1] adjacency_horizontal = np.zeros((nrows, ncols), dtype=np.uint32)
 *     cdef int x, y, span
 *     for y in prange(nrows, nogil=True, schedule="static"):             # <<<<<<<<<<<<<<
 *         span = 0
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_9 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_span) lastprivate(__pyx_v_x) firstprivate(__pyx_v_y) lastprivate(__pyx_v_y) schedule(static)
                    #endif /* _OPENMP */
                    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                        {
                            __pyx_v_y = (int)(0 + 1 * __pyx_t_8);
                            /* Initialize private variables to invalid values */
                            __pyx_v_span = ((int)0xbad0bad0);
                            __pyx_v_x = ((int)0xbad0bad0);

                            /* "cy_horizontal_adjacency.pyx":15
 *     cdef int x, y, span
 *     for y in prange(nrows, nogil=True, schedule="static"):
 *         span = 0             # <<<<<<<<<<<<<<
 *         for x in reversed(range(ncols)):
 ...
 */
                            ...
                            /* "cy_horizontal_adjacency.pyx":16
 *     for y in prange(nrows, nogil=True, schedule="static"):
 *         span = 0
 *         for x in reversed(range(ncols)):             # <<<<<<<<<<<<<<
 *             if cells[y, x] > 0:
 *                 span += 1
 */
                            for (__pyx_t_10 = __pyx_v_ncols-1; __pyx_t_10 >= 0; __pyx_t_10-=1) {
                              __pyx_v_x = __pyx_t_10;

                              /* "cy_horizontal_adjacency.pyx":17
 *         span = 0
 *         for x in reversed(range(ncols)):
 *             if cells[y, x] > 0:             # <<<<<<<<<<<<<<
 *                 span += 1
 ...
 */
                              ...
                              __pyx_t_13 = (((*((uint8_t *) ( /* dim=1 */ ((char *) (((uint8_t *) ( /* dim=0 */ (__pyx_v_cells.data + __pyx_t_11 * __pyx_v_cells.strides[0]) )) + __pyx_t_12)) ))) > 0) != 0);
                              if (__pyx_t_13) {

                                /* "cy_horizontal_adjacency.pyx":18
 *         for x in reversed(range(ncols)):
 *             if cells[y, x] > 0:
 *                 span += 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
                              ...
                              /* "cy_horizontal_adjacency.pyx":20
 *                 span += 1
 *             else:
 *                 span = 0             # <<<<<<<<<<<<<<
 ...
 */
                              ...
                              /* "cy_horizontal_adjacency.pyx":21
 *             else:
 *                 span = 0
 *             adjacency_horizontal[y, x] = span             # <<<<<<<<<<<<<<
 *     return np.array(adjacency_horizontal, copy=False)
 */
                              ...
                              *((uint32_t *) ( /* dim=1 */ ((char *) (((uint32_t *) ( /* dim=0 */ (__pyx_v_adjacency_horizontal.data + __pyx_t_12 * __pyx_v_adjacency_horizontal.strides[0]) )) + __pyx_t_11)) )) = __pyx_v_span;
                            }
                        }
                    }
                }
 ...
 */
  ...
  /* "cy_horizontal_adjacency.pyx":22
 *                 span = 0
 *             adjacency_horizontal[y, x] = span
 *     return np.array(adjacency_horizontal, copy=False)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_array); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_adjacency_horizontal, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn_uint32_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn_uint32_t, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_copy, Py_False) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_adjacency_horizontal, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cy_horizontal_adjacency.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cy_horizontal_adjacency.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cy_horizontal_adjacency.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cy_horizontal_adjacency._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cy_horizontal_adjacency(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cy_horizontal_adjacency},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_adjacency_horizontal, __pyx_k_adjacency_horizontal, sizeof(__pyx_k_adjacency_horizontal), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_cy_horizontal_adjacency, __pyx_k_cy_horizontal_adjacency, sizeof(__pyx_k_cy_horizontal_adjacency), 0, 0, 1, 1},
  {&__pyx_kp_s_cy_horizontal_adjacency_pyx, __pyx_k_cy_horizontal_adjacency_pyx, sizeof(__pyx_k_cy_horizontal_adjacency_pyx), 0, 0, 1, 0},
 ...
 *     cdef int ncols = cells.shape[1]
 */
  __pyx_tuple__19 = PyTuple_Pack(8, __pyx_n_s_cells, __pyx_n_s_cells, __pyx_n_s_nrows, __pyx_n_s_ncols, __pyx_n_s_adjacency_horizontal, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_span); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cy_horizontal_adjacency_pyx, __pyx_n_s_cy_get_horizontal_adjacency, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 9, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcy_horizontal_adjacency(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcy_horizontal_adjacency(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cy_horizontal_adjacency(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cy_horizontal_adjacency(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cy_horizontal_adjacency(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cy_horizontal_adjacency' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cy_horizontal_adjacency(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cy_horizontal_adjacency", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cy_horizontal_adjacency) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cy_horizontal_adjacency")) {
      if (unlikely(PyDict_SetItemString(modules, "cy_horizontal_adjacency", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int ncols = cells.shape[1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_23cy_horizontal_adjacency_1cy_get_horizontal_adjacency, NULL, __pyx_n_s_cy_horizontal_adjacency); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cy_get_horizontal_adjacency, __pyx_t_1) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cy_horizontal_adjacency.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cy_horizontal_adjacency", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cy_horizontal_adjacency");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_uint8_t(PyObject *obj, int writable_flag) {
